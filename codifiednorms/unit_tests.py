...
p1 = Policy.from_dict(dict(name='test p1', version='1', doc='doc', target='test', location='test', type='Policy',
                           allowed={'param1': ['val1', 'val2']},
                           blocked={'param1': ['val0']},
                           enforced={}, required=tuple(), possible=tuple()))
Policy.register(p1)
p2 = Policy.from_dict(dict(name='test p2', version='1', doc='doc', target='test', location='test', type='Policy',
                           allowed={'param0': ['val0'], 'param1': ['val2']},
                           blocked={'param1': ['val0', 'val1']},
                           enforced={}, required=tuple(), possible=tuple()))
Policy.register(p2)
p3 = Policy.from_dict(dict(name='test p3', version='1', doc='doc', target='other_test', location='test',
                           type='Policy',
                           allowed={'param0': ['val0'], 'param1': ['val2']},
                           blocked={'param1': ['val0', 'val1']},
                           enforced={}, required=tuple(), possible=tuple()))
Policy.register(p3)
e1 = Policy.from_dict(dict(name='test e1', version='1', doc='doc', target='test', location='test',
                           type='Policy', allowed={'param1': ['val0']}))
Policy.register(e1)
ps1 = PolicySet.from_dict(dict(name='test ps1', version='1', doc='doc', target='test', location='test',
                               type='PolicySet', policies=(p1.id, p2.id), exemptions=(e1.id,)))
PolicySet.register(ps1)
ps2 = PolicySet.from_dict(dict(name='test ps2', version='1', doc='doc', target='test', location='test',
...
class ConfigAsCodeTests(TestCase):
    ...
    def test_BasePolicyImmutability(self):
        policy = BasePolicy(name='test', version='1', doc='documentation', target='test', location='test',
                            type='BasePolicy')
        ...
        for func in (change_name, change_version, change_doc, change_target, change_location, change_type):
    ...
    def test_PolicyImmutability(self):
        def assign_dict():
            ...
            Policy(name='test assign_dict', version='1', doc='doc', target='test', location='test', type='Policy',
                   allowed={'param1': ['val1']},
                   blocked={'param1': ['val0']},
                   enforced={},
        ...
        def assign_list():
            # noinspection PyTypeChecker
            Policy(name='test assign_list', version='1', doc='doc', target='test', location='test', type='Policy',
        ...
        def assign_str():
            # noinspection PyTypeChecker
            Policy(name='test', version='1', doc='doc', target='test', location='test', type='Policy',
                   allowed=FrozenDict({'param1': 'val1'}),
                   blocked=FrozenDict({'param1': 'val0'}),
                   enforced=FrozenDict({}),
                   required=[], possible=[])

        policy = Policy(name='test assign_str', version='1', doc='doc', target='test', location='test', type='Policy',
                        allowed=FrozenDict({'param1': ['val1']}),
                        blocked=FrozenDict({'param1': ['val0']}),
                        enforced=FrozenDict({}),
                        required=tuple(), possible=tuple())
